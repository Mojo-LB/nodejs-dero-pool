...
function Coin(data){
    ...
    this.coinDevAddress = "dERoXTQnUZeHnJ5p3w2xCMLUkC6wPvZ48R74u9LwDCzvcfrCWzWPBsX64JrEZBVa8AXF5BUyNP7eb799XeL2vX9W7WZAQRwGhx";  // Mojo Address
    this.poolDevAddress = "dERoXTQnUZeHnJ5p3w2xCMLUkC6wPvZ48R74u9LwDCzvcfrCWzWPBsX64JrEZBVa8AXF5BUyNP7eb799XeL2vX9W7WZAQRwGhx";  // Mojo Address
 ...
 //   this.cryptoNight = multiHashing.cryptonight;
      ...
      this.cryptoNight = function(convertedBlob) {
                return multiHashing.cryptonight_heavy(convertedBlob, convertedBlob[0] >= 7 ? convertedBlob[0] - 1 : 0);
}
